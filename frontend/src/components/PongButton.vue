...
<template>
  <button
    ...
    :class="[
      ...
      fullWidth ? 'w-full' : '',
      disabled ? 'bg-[var(--color_disabled)] text-[var(--color_accent_1)] cursor-not-allowed': 'bg-[var(--color_background_1)] text-[var(--color_accent_1)] hover:bg-[var(--color_accent_1)] hover:text-[var(--color_background_1)]'
    ]"
    @click="handleClick"
  >
    {{ label }}
